<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_group_operations')): ?>
                <li class="nav-item dropdown <?php echo e((request()->is(getAdminPanelUrl('/group-operations*', false))) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fas fa-user-plus"></i>
                        <span>Group Operations</span>
                    </a>
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_group_operations_list')): ?>
                            <li class="<?php echo e((request()->is(getAdminPanelUrl('/group-operations/list', false))) ? 'active' : ''); ?>">
                                <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/group-operations/list">Groups</a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_group_operations_add_group')): ?>
                            <li class="<?php echo e((request()->is(getAdminPanelUrl('/group-operations/add-group', false))) ? 'active' : ''); ?>">
                                <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/group-operations/add-group">Add Group</a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_group_operations_add_student_to_group')): ?>
                            <li class="<?php echo e((request()->is(getAdminPanelUrl('/group-operations/add-student-to-group', false))) ? 'active' : ''); ?>">
                                <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/group-operations/add-student-to-group">Add Student</a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
...
<?php /**PATH /home/mohamed/projects/ims/resources/views/admin/includes/sidebar.blade.php ENDPATH**/ ?>