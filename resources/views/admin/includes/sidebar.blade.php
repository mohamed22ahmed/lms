<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @can('admin_group_operations')
                <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/group-operations*', false))) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fas fa-user-plus"></i>
                        <span>Group Operations</span>
                    </a>
                    <ul class="dropdown-menu">
                        @can('admin_group_operations_list')
                            <li class="{{ (request()->is(getAdminPanelUrl('/group-operations/list', false))) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/group-operations/list">Groups</a>
                            </li>
                        @endcan

                        @can('admin_group_operations_add_group')
                            <li class="{{ (request()->is(getAdminPanelUrl('/group-operations/add-group', false))) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/group-operations/add-group">Add Group</a>
                            </li>
                        @endcan

                        @can('admin_group_operations_add_student_to_group')
                            <li class="{{ (request()->is(getAdminPanelUrl('/group-operations/add-student-to-group', false))) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/group-operations/add-student-to-group">Add Student</a>
                            </li>
                        @endcan
                    </ul>
                </li>
